...
.mensagem-box {
    margin-bottom: 10px; /* Margem inferior para separar das outras partes do formulário */
}
...
.mensagem {
    ...
    margin-bottom: 10px; /* Margem inferior para separar das outras partes da página */
...
<body>
    <div class="center">
        <div class="container">
            <h2>Calculadora</h2>
            <form method="post">
                <!-- Adicionando uma div para exibir mensagens -->
                ...
                <button type="submit" name="acao" value="<?php echo (isset($_SESSION['num1']) && isset($_SESSION['num2']) && isset($_SESSION['operacao'])) ? 'recuperar' : 'salvar'; ?>">M</button>
